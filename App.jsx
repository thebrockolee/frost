...
const DISCORD_URL = "https://discord.gg/frostesports";
...
export default function TournamentSignupWebsite() {
  ...
  const removeSubstitute = (id) => {
    ...
    setCaptainId((currentCaptainId) =>
      currentCaptainId === id ? null : currentCaptainId
    );
  };
      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-950 px-5 text-white">
        ...
        >
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-7 text-slate-300">
            Thanks for registering for the Frost Esports Overwatch tournament.
            Our staff will review your submission and reach out if anything needs
            to be corrected.
          </p>
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-16 md:py-24">
          ...
          >
            ...
            <p className="mt-5 text-lg leading-8 text-slate-300">
              Register your full roster, captain, coach, and substitute
              information in one place. Please make sure all Blizzard IDs,
              Discord handles, and emails are accurate before submitting.
            </p>
          </motion.div>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
          <form className="space-y-7" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <OptionalRole
                title="Captain"
                onAdd={addCaptain}
                disabled={separateCaptainDisabled || hasSeparateCaptain}
              />
              <OptionalRole title="Coach" onAdd={addCoach} />
            </div>

            {separateCaptainDisabled ? (
              <div className="rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-4 text-sm leading-6 text-cyan-100">
                A player is already marked as captain. Unmark them if you want to
                add a separate captain contact instead.
              </div>
            ) : null}
              ...
              <div className="mt-6 space-y-4">
                {substitutes.length === 0 ? (
                  <label className="flex gap-3 rounded-2xl border border-white/10 bg-slate-950/60 p-4 text-sm leading-6 text-slate-300">
                    ...
                    />
                    <span>
                      I acknowledge that my team may lose the right to an
                      emergency substitute by not registering a substitute.
                    </span>
                  </label>
                ) : null}
                ...
                <label className="flex gap-3 rounded-2xl border border-white/10 bg-slate-950/60 p-4 text-sm leading-6 text-slate-300">
                  ...
                  />
                  <span>
                    I consent to receiving emails from Frost Esports regarding
                ...
                <label className="flex gap-3 rounded-2xl border border-white/10 bg-slate-950/60 p-4 text-sm leading-6 text-slate-300">
                  ...
                  />
                  <span>
                    I acknowledge and agree that Frost Esports may collect,
                    store, and use the information submitted in this form,
                    including names, emails, Discord usernames, Battle.net IDs,
                    social handles, roster details, and related registration
                    data, for tournament administration, communication,
                    eligibility review, event operations, and recordkeeping
                    purposes.
                  </span>
                </label>
              </div>
          ...
          <aside className="h-fit rounded-3xl border border-white/10 bg-white/[0.04] p-6 lg:sticky lg:top-6">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              Before submitting, double-check every required field and make sure
              your captain is clearly marked.
            </p>
            ...
            <div className="mt-7 rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-300">
                Questions about registration, emergency substitutes, or tournament
                rules can be sent to tournament staff.
              </p>
              <a
                href={DISCORD_URL}
                target="_blank"
